        ...
        while (id <= end) : (id += 1) {
            ...
            group: for (2..9) |divisor| {
                ...
                for (0..divisor - 1) |i| {
                    if (!std.mem.eql(
                        u8,
                        id_str[(i + 0) * len .. (i + 1) * len],
                        id_str[(i + 1) * len .. (i + 2) * len],
                    )) {
                        continue :group;
                    }
                }
...
test "day 2 - part 1" {
    ...
    const test_data = [_]struct {
        ...
        .{
            .input = "11-22",
            .invalid_ids = &[_]u32{ 11, 22 },
        },
        .{
            .input = "95-115",
            .invalid_ids = &[_]u32{99},
        },
        .{
            .input = "998-1012",
            .invalid_ids = &[_]u32{1010},
        },
        .{
            .input = "1188511880-1188511890",
            .invalid_ids = &[_]u32{1188511885},
        },
        .{
            .input = "222220-222224",
            .invalid_ids = &[_]u32{222222},
        },
        .{
        ...
        .{
            .input = "446443-446449",
            .invalid_ids = &[_]u32{446446},
        },
        .{
            .input = "38593856-38593862",
            .invalid_ids = &[_]u32{38593859},
        },
        .{
            .input = "565653-565659",
            .invalid_ids = &[_]u32{},
...
test "day 2 - part 2" {
    ...
    const test_data = [_]struct {
        ...
        .{
            .input = "95-115",
            .invalid_ids = &[_]u32{ 99, 111 },
        },
        .{
            .input = "998-1012",
            .invalid_ids = &[_]u32{ 999, 1010 },
        },
        .{
            .input = "1188511880-1188511890",
            .invalid_ids = &[_]u32{1188511885},
        ...
        .{
            .input = "565653-565659",
            .invalid_ids = &[_]u32{565656},
        },
        .{
            .input = "824824821-824824827",
            .invalid_ids = &[_]u32{824824824},
        },
        .{
            .input = "2121212118-2121212124",
            .invalid_ids = &[_]u32{2121212121},
        },
    };
